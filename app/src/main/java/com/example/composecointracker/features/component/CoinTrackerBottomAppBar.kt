...
import com.example.composecointracker.features.navigation.BottomNav
import com.example.composecointracker.features.navigation.navigateCoinList
import com.example.composecointracker.features.navigation.navigateFavorite
import com.example.composecointracker.features.theme.BLUE
import com.example.composecointracker.features.theme.BOTTOM_BAR_SELECTED
import com.example.composecointracker.features.theme.BOTTOM_BAR_UNSELECTED

@Composable
fun CoinTrackerBottomAppBar(
...
fun navigateToBottomNavDestination(bottomNav: BottomNav, navController: NavController) {
    trace("Navigation: ${bottomNav.name}") {
        ...
        when (bottomNav) {
            BottomNav.COIN -> navController.navigateCoinList(bottomNavOptions)
